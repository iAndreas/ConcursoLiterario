...
<head>
  <meta charset="UTF-8">
  <title>LITTERAE | Cadastro de Alunos</title>
		                ...
		                <!--        You can switch " data-color="blue" "  with one of the next bright colors: "green", "orange", "red", "purple"             -->
								...
								<div class="wizard-navigation">
									<ul>
			                            ...
			                            <li><a href="#cadastro" data-toggle="tab">Cadastro de Alunos</a></li>
	                        	...
	                        	<div class="wizard-footer">
	                            	<div class="pull-right">
	                                    <button class='btn btn-finish btn-fill btn-danger btn-wd' name='cadA'>Cadastrar</button>
	                                </div>
	                                <div class="pull-left">
