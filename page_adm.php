...
<?php
  ...
  if (!isset($_SESSION['logadoAdm']) and isset($_SESSION['logadoJ'])){
    header('Location: page_jurado.php?erro=erroA');
  }else if (!isset($_SESSION['logadoAdm']) and isset($_SESSION['logadoA'])){
    header('Location: page_aluno.php?erro=erroA');
...
<head>
  ...
  <title>LITTERAE | Administrador</title>
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="#">
              <i class="material-icons">show_charts</i>
              <p>Avaliações</p>
            </a>
          </li>
        </ul>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Página Inicial</a>
          </div>
